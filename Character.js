...
export class Character extends MobileEntity {
    constructor(x, y) {
        super(x, y, 'player');
    ...
    update(dt, inputVector, isSprinting, collisionCheck) {
        ...
        // 2-6. Physics Update (Delegated to MobileEntity)
        const moved = this.updatePhysics(dt, inputVector, currentMaxSpeed, collisionCheck);
        ...
        // Distance moved this frame = speed * (dt / 16.0)
        const timeScale = dt / 16.0;
        const distMoved = speed * timeScale;
